...
# Gill Color
The gills on the mushrooms are the ribs underneth the cap. I color coded the colors to match. Here we see that all of the buff colored ribs are poisonous. 
...
# Population
Population of the mushrooms consist if they grow in groups to growing alone. The graph are in order of these groups from growing abudent together to growing in solitary.
...
# Spore Print
The spores of a mushrooms are the micro substance that a mushroom could release. Here we seee that both edible and poisonous has about equal amount. But in that graph it shows that green and purple spores represent poisonous. 
